...
public class FrigoListeAdapter  extends ArrayAdapter<DataModal> {

    // constructor for our list view adapter.
    public FrigoListeAdapter(@NonNull Context context, ArrayList<DataModal> dataModalArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listitemView == null) {
            listitemView = LayoutInflater.from(getContext()).inflate(R.layout.item_liste_frigo, parent, false);
        }
        ...
        nameTV.setText(dataModal.getType());
